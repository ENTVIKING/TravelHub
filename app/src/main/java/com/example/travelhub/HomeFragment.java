...
public class HomeFragment extends Fragment {
    ...
    public HomeFragment(ArrayList<String> Title, ArrayList<Integer> ImageAddress) {
        this.Title = Title;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        RecyclerView recycler = HomeFrag.findViewById(R.id.recyclerHome);
        ItemAdapter itemAdapter = new ItemAdapter(getContext(), Title, ImageAddress);
